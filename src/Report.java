...
public class Report extends JFrame {
    ...
    public void callReport(boolean save, String destPath, String url) {
        JasperPrint jasperPrint = generateReport(url);
        JRViewer viewer = new JRViewer(jasperPrint);
        Container c = getContentPane();
        c.add(viewer);
        if(save)
            this.exportToPdf(jasperPrint, destPath);
    ...
    public JasperPrint generateReport(String url) {
        try {
            if (con == null) {
                try {
    ...
    public void exportToPdf(JasperPrint jp, String destPath) {
        try{
